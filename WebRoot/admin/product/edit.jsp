	...
	<form id="userAction_save_do" name="Form1"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					是否热门：</td>
				<td class="ta_01" bgColor="#ffffff"><label for="yes">是</label>
					<input type="radio" value="" name="is_hot" id="yes"
					<s:if
						test="model.is_hot==1">checked="checked"</s:if> /> <label
					for="no">否</label> <input <s:if
						test="model.is_hot==0">checked="checked"</s:if>  type="radio" value="" name="is_hot"
					id="no" />
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3"><select
					name="categorySecond.csid">
						<s:iterator var="cs" value="csList">
							...
							<option
								<s:if test="model.categorySecond.csid==#cs.csid">selected</s:if>
								value="<s:property value="#cs.csid"/>">
