		...
		<div class="span6">
			<div class="hotProductCategory">
					...
					<dl>
						<dt>
							<a
								href="${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property value="#c.cid"/>"><s:property
									value="#c.cname" /> </a>
						</dt>
		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					...
					<dd>商城价:<strong>  <s:property value="model.shop_price"/>   </strong>
							参 考 价：
							<del>￥<s:property value="model.market_price"/></del>
					</dd>
				</dl>
					<dl>
						<dt>促销:<s:property value="model.market_price"/></dt>
						<dd>
			...
			<input name="pid" value="<s:property value="model.pid"/>" type="hidden"/>
				<div class="action">
