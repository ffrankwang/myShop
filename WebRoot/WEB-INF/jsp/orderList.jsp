			...
			<s:iterator var="order" value="pageBean.list">
				<table>
					<tbody>
						...
						<tr>
							<th colspan="5">订单编号：<s:property value="#order.oid" />&nbsp;&nbsp;&nbsp;&nbsp;订单状态：<s:if
									test="#order.state==1">
									<a
										href="${pageContext.request.contextPath }/order_findOrderByOid.action?oid=<s:property value="#order.oid" />"><font
										color="orange">待付款 </font> </a>
								</s:if> <s:if test="#order.state==2">
									<a href="#"><font color="green">已付款 </font> </a>
								</s:if> <s:if test="#order.state==3">
									<a href="#"><font color="blue">确认收货</font> </a>
								</s:if> <s:if test="#order.state==4">
									<a href="#"><font color="grey">交易成功 </font> </a>
								</s:if>
							</th>
						</tr>
						<tr>
						...
						<s:iterator var="orderItem" value="#order.orderItems">
							<tr>
								...
								<td class="quantity" width="60"><input type="text"
									name="count" value="1" maxlength="4" onpaste="return false;" />
									<div>
							...
							<th colspan="5">
								<div class="pagination">
									...
									<s:if test="pageBean.page != 1">
										<a
											href="${ pageContext.request.contextPath }/order_findOrderByUid.action?page=1"
											class="firstPage">&nbsp;</a>
										<a
											href="${ pageContext.request.contextPath }/order_findOrderByUid.action?page=<s:property value="pageBean.page-1"/>"
											class="previousPage">&nbsp;</a>
									</s:if>
									<s:iterator var="i" begin="1" end="pageBean.totalPage">
										<s:if test="pageBean.page != #i">
											<a
												href="${ pageContext.request.contextPath }/order_findOrderByUid.action?page=<s:property value="#i"/>"><s:property
													value="#i" /> </a>
										</s:if>
										<s:else>
									...
									<s:if test="pageBean.page != pageBean.totalPage">
										<a class="nextPage"
											href="${ pageContext.request.contextPath }/order_findOrderByUid.action?page=<s:property value="pageBean.page+1"/>">&nbsp;</a>
										<a class="lastPage"
											href="${ pageContext.request.contextPath }/order_findOrderByUid.action?page=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
									</s:if>
								</div></th>
						</tr>
		</div>
